...
public class ModificationAssignment {
	   ...
	   public ModificationAssignment(AssignmentType modificationType, boolean assignmentSolved) {
	   ...
	   public void setAssignmentTypeCode(int assignmentCode) {
	      this.assignmentTypeCode = AssignmentType.getAssignmentType(assignmentCode);
	   }
